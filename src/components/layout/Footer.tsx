        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold font-heading">EcoGlow</span>
            </div>
            <p className="text-white/70 text-sm mb-2">{SITE_TAGLINE}</p>
            <p className="text-white/60 text-sm">High-quality, eco-friendly cleaning solutions made in Kenya.</p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-semibold mb-4 font-heading">Products</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold mb-4 font-heading">Contact Us</h3>
